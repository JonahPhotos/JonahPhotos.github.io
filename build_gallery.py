...
def build_grid(subset):
    ...
    for i, p in enumerate(subset):
        ...
        g += f'<div class="photo-item" data-large="{l}" data-name="{p["name"]}" onclick="openLightbox({i})"><img src="{t}" loading="lazy" alt="{p["name"]}"></div>'
    return g + "</main>"
...
for g in sorted_groups:
    ...
    idx += f'<a href="{g}.html" class="album-card"><img src="images/thumbs/{g}/{first["clean"]}.webp" loading="lazy"><p>{label}</p></a>'
